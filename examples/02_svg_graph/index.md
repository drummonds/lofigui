...
<a target="_blank" href="https://git.bytestone.uk/hum3/lofigui/src/branch/main/examples/02_svg_graph" class="button is-light">Source on Forgejo</a>
</div>
...
[model.go source on Forgejo](https://git.bytestone.uk/hum3/lofigui/src/branch/main/examples/02_svg_graph/go/model.go)
...
[charts.go source on Forgejo](https://git.bytestone.uk/hum3/lofigui/src/branch/main/examples/02_svg_graph/go/charts.go)
...
[main.go source on Forgejo](https://git.bytestone.uk/hum3/lofigui/src/branch/main/examples/02_svg_graph/go/main.go)
...
[main_wasm.go source on Forgejo](https://git.bytestone.uk/hum3/lofigui/src/branch/main/examples/02_svg_graph/go/main_wasm.go)
