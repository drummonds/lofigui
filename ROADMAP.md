...
- **Go WASM**: Examples 01, 03, 07, 08 deployed on GitHub Pages
- **Multi-page pattern**: Server-side multi-route + WASM tabbed equivalent (example 08)
- **Python WASM**: Pyodide proof-of-concept (example 03)
...
- **HTMX integration**: Optional partial page updates without full reload
